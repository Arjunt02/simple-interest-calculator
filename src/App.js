          ...
          <form onSubmit={calculateInterest}>
              ...
              <div className='input'>
                <TextField value={rate||""}
                 onChange={e => setRate(e.target.value)}
                  className='outlined-basic' id="outlined-basic" label="Rate of interest" variant="outlined" />
              </div>
            ...
            <div className='btn-group'>
              <Stack direction="row" spacing={2}>
                <Button type='submit' className='btn' style={{ backgroundColor: 'goldenrod' }} variant="contained">Calculate</Button>
